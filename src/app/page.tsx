...
<section className="relative w-full h-screen overflow-hidden bg-gray-900">
      ...
      <div className="absolute top-16 sm:top-20 md:top-24 left-0 right-0 flex flex-col justify-start items-center md:items-start z-20 text-white px-4 sm:px-6 md:px-10 lg:px-16">
