...
export default function TimeLine(){
    ...
    <>
        <Header/>
        <section className="max-w-6xl mx-auto px-4 py-16 grid md:grid-cols-2 gap-x-20 gap-y-12">
        {/* Nossa História */}
        <div className="flex flex-col space-y-6">
          ...
          <div className="rounded-xl overflow-hidden shadow-lg w-full max-w-[400px]">
            <Image
              src={historia02}
      ...
      <section className="bg-[#0A0A13] text-white py-16 px-6">
      ...
      <section className="bg-[#ffff] text-white py-16 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          {/* Texto à esquerda */}
          <div>
